...
//         const contentRes = await api.get('/content/trending', {
...
//         const creatorsRes = await api.get('/users/popular-creators');
//         setPopularCreators(creatorsRes.data.creators);
        
//         // Fetch categories
//         const categoriesRes = await api.get('/content/categories');
...
//         {loading ? (
//           <div className="text-center">Loading trending content...</div>
...
//             <p>No trending content available in this category.</p>
//           </div>
//         )}
//       </div>
...
//         {loading ? (
//           <div className="text-center">Loading popular creators...</div>
